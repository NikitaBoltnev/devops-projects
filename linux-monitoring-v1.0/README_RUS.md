...
После вывода значений появляется предложение записать данные в файл (предложение пользователю ответить **Y/N**).  
...
Написан bash-скрипт. За основу взят скрипт из [**Part 2**](#part-2-исследование-системы) и из него удалена часть, ответственная за сохранение данных в файл.
...
Написан bash-скрипт. За основу взят скрипт из [**Part 3**](#part-3-визуальное-оформление-вывода-для-скрипта-исследования-системы). Обозначения цветов аналогичные.  
...
После вывода информации о системе из [**Part 3**](#part-3-визуальное-оформление-вывода-для-скрипта-исследования-системы), сделав отступ в одну пустую строку, выводится цветовая схема в следующем виде:
```
...
Написан bash-скрипт. Скрипт запускается с одним параметром.  
